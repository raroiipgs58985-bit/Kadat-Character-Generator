...
require("../power-armor-data.js");
const data = global.window.KADAT_POWER_ARMOR_DATA;
const engine = require("../power-armor-engine.js");
...
assert.deepEqual(engine.validate({
  classId: "medium", groundSpeed: 15, alternateMovementType: "jump", alternateSpeed: 10,
  leftManipulatorId: "manipulator", rightManipulatorId: "servo-claws", armorId: "prototype"
}, data), []);
assert(engine.validate({
  classId: "heavy", groundSpeed: 15, alternateMovementType: "flight", alternateSpeed: 5,
  leftManipulatorId: "glove", rightManipulatorId: "glove", armorId: "standard"
}, data).length >= 1);
