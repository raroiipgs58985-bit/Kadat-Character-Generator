(() => {
  ...
  function restore(value) {
    ...
    refs.progress[0].parentElement.classList.remove("hidden");
    render();
    window.KadatModes.restored("power-armor");
  }
  buildShell();
